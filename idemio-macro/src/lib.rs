...
/// TODO[AI GENERATED] -- Majority of this macro is AI generated.
...
//                syn::Error::new_spanned(input, "LabeledHandler can only be derived for structs.")
//                    .to_compile_error(),
//            );
//        }
//    };
...
//                input,
//                "LabeledHandler can only be derived for structs with exactly one field.",
//            )
//            .to_compile_error(),
//        );
//    }
...
//    let generated = quote! {
//        impl ::idemio::handler::LabeledHandler for #struct_name {
//            fn id(&self) -> &'static str {
//                stringify!(#struct_name)
//            }
//        }
//        impl #struct_name {
//            pub fn init(config: Config<#inner_type>) -> #struct_name {
//                #struct_name {
//                    config
//                }
//            }
//            pub fn reload(&mut self, config: Config<#inner_type>) {
//                self.config = config;
//            }
